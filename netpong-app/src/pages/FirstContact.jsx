...
export default function FirstContact() {
    ...
    const teamMembers = [
        {
            ...
            initial: 'A',
            image: 'https://lh3.googleusercontent.com/a/ACg8ocIMszu0k-YG-YYe6aqXU2LHofnPSfe1uwXCcYHW9SkUushAJv--fQ=s494-c-no',
        ...
        },
        {
            ...
            initial: 'H',
            image: 'https://lh3.googleusercontent.com/a/ACg8ocLvQrSp6qVLZavaP67QoF6VjgP89QLpExpsAh-7DgWnB0eEgLRGDg=s576-c-no',
    ...
    return (
        <div className="min-h-screen">
            <FirstHeader />
            <div className="antialiased w-full bg-slate-900 text-white">
                ...
                <div className="container mx-auto px-4 py-12 md:py-16">
                    ...
                    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-6xl mx-auto justify-center">
