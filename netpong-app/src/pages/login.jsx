              ...
              <div className="relative mb-8">
                <input
                  ...
                  className="w-full bg-white/10 text-zinc-100 p-2 pl-10 md:pl-12 pr-12
                          rounded-xl border-2 border-violet-500/50 backdrop-blur-sm shadow-xl
                          h-14 md:h-16 hover:bg-white/15 hover:border-violet-400
                          focus:outline-none focus:border-violet-400 focus:bg-white/15
                          peer transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                />

                <span className="absolute top-1/2 left-3 md:left-4 -translate-y-1/2
                                text-zinc-200 pointer-events-none font-bold text-sm md:text-base
                                peer-focus:text-xs peer-focus:top-2 peer-focus:text-violet-300
                                peer-[:not(:placeholder-shown)]:text-xs
                                peer-[:not(:placeholder-shown)]:top-2
                                peer-[:not(:placeholder-shown)]:text-violet-300 transition-all">
                  Password
                </span>
