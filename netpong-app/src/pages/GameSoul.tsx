        ...
        return (
            <div className="relative h-[100svh] overflow-hidden">
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-center p-6 gap-6">
                    ...
                    <h2 className="text-3xl font-extrabold text-cyan-400" style={{ textShadow: '0 0 20px rgba(120,180,255,0.6)' }}>Game Already Active</h2>
                    ...
                    <button onClick={() => navigate('/soul-society')} className="mt-4 bg-gray-600 hover:bg-gray-500 text-white font-bold py-3 px-8 rounded-xl transition-all hover:scale-105" style={{ boxShadow: '0 0 20px rgba(120,180,255,0.3)' }}>← Go Back</button>
                </div>
            </div>
        );
    }
