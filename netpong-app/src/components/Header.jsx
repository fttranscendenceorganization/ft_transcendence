    ...
    return (
        <header className="sticky top-0 w-full bg-slate-900/95 backdrop-blur-md py-4 flex flex-col md:flex-row items-center justify-between px-4 md:px-6 z-50 shadow-lg border-b border-white/10 gap-4 md:gap-0">
            ...
            <nav className="md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 flex flex-wrap justify-center items-center gap-4 md:gap-8 text-sm md:text-base">
                <Link to="/home" className="text-white font-bold hover:text-orange-400 transition-all duration-300 relative group">
                    Home
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-orange-400 transition-all duration-300 group-hover:w-full"></span>
                </Link>

                <Link to="/exclusive" className="text-white font-bold hover:text-orange-400 transition-all duration-300 relative group">
                    Exclusive
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-orange-400 transition-all duration-300 group-hover:w-full"></span>
                </Link>
                ...
                <div className="relative" ref={dropdownRef}>
                    <button
                        ...
                        className="text-white font-bold hover:text-orange-400 cursor-pointer transition-all duration-300 flex items-center gap-2 relative group"
                    >
                        Game Modes
                        <svg
                    ...
                    >
                        <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 px-4 py-3 border-b border-white/10">
                            <p className="text-xs font-bold text-orange-400 uppercase tracking-wider">Choose Your Mode</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-slate-900/50 to-slate-800/50 px-4 py-2 border-t border-white/10">
                            <p className="text-xs text-center text-gray-400">4 Unique Experiences</p>
                        </div>
                    </div>
                </div>

                <Link to="/contact" className="text-white font-bold hover:text-orange-400 transition-all duration-300 relative group">
                    Contact
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-orange-400 transition-all duration-300 group-hover:w-full"></span>
                </Link>
            </nav>
            ...
            <div className="flex items-center gap-4">
                <Link
                    to="/chat"
                    className="relative overflow-hidden bg-gradient-to-r from-red-700 to-red-600 
                   hover:from-red-600 hover:to-red-500
                   text-white py-2 px-4 md:px-5 font-bold rounded-xl 
                ...
                <button
                    ...
                    className="bg-slate-800 hover:bg-red-700 
