    ...
    return (
        <header className="w-full bg-slate-900/95 backdrop-blur-sm py-4 relative flex flex-col md:flex-row items-center justify-between px-4 md:px-6 z-20 shadow-md gap-4 md:gap-0">
            <Link to="/" className="flex items-center">
                <img src="/images/saule.svg" alt="NETPONG Logo" className="h-8 md:h-10 w-auto" />
            </Link>
            ...
            <nav className="md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 flex flex-wrap justify-center items-center gap-4 md:gap-8 text-sm md:text-base">
                <Link to="/" className="text-white font-bold hover:text-gray-400 transition">
                    Home
                </Link>
                <Link to="/exclusive" className="text-white font-bold hover:text-gray-400 transition">
                    Exclusive
                </Link>
                ...
                <div className="relative">
                    <button
                        ...
                        className="text-white font-bold hover:text-gray-400 cursor-pointer transition"
                    >
                        Game Modes ▼
                    </button>
                ...
                <Link to="/contact" className="text-white font-bold hover:text-gray-400 transition">
                    Contact
                </Link>
            </nav>

            <Link to="/chat" className="bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 md:px-5 font-bold rounded-lg shadow-xl transition text-sm md:text-base">
                START CHAT
            </Link>
        </header>
    );
